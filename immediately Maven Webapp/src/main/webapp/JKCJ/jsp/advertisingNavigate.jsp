...
<div class="layui-layout layui-layout-admin">
    <div class="layui-header">
        ...
        <ul class="layui-nav layui-layout-right">
            ...
            <li class="layui-nav-item"><a href="http://www.baidu.com" class="login-out">退出</a></li>
        </ul>
    </div>
        ...
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="test">
                <li class="layui-nav-item layui-nav-itemed">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a href="Quick">快讯广告</a></dd>
                        <dd><a href="Policy">政策广告</a></dd>
                        <dd class="layui-this"><a href="Navigate">导航广告</a></dd>
                    </dl>
                </li>
   ...
   <div class="layui-body">
        ...
        <div class="advertis-content">
           ...
           <div class="advertis-block">
               <span>广告位1</span>
  <form method="post" action="ImageDate2" class="layui-form">
               <img title="点击图片选择需要更换的图片" src="upload/${a1}" class="adv-img-btn7" ><!--  -->
         <input type="hidden" id="id7" name="id" value="7"></input>
             <input type="hidden" id="a7" name="aa"></input>
            
             <input type="hidden" id="type7" name="type" value="1"></input>
               <div class="adv-btns">
            ...
            <div class="advertis-block">
                <span>广告位2</span>
                 <form method="post" action="ImageDate2" class="layui-form">
                <img title="点击图片选择需要更换的图片" src="upload/${a2}" class="adv-img-btn8" ><!--  -->
          <input type="hidden" id="id8" name="id" value="8"></input>
             <input type="hidden" id="a8" name="aa"></input>
            
             <input type="hidden" id="type8" name="type" value="1"></input>
               <div class="adv-btns">
            ...
            <div class="advertis-block">
                <span>广告位3</span>
                  <form method="post" action="ImageDate2" class="layui-form">
                 <img title="点击图片选择需要更换的图片" src="upload/${a3}" class="adv-img-btn9" ><!--  -->
         <input type="hidden" id="id9" name="id" value="9"></input>
             <input type="hidden" id="a9" name="aa"></input>
            
             <input type="hidden" id="type9" name="type" value="1"></input>
