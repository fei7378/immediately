...
<div class="body-content">
    ...
    <main class="jk-main">
        ...
        <div class="layui-container">
            ...
            <!--列表内容-->
            <div class="left-content" style="text-align: center;min-height: 500px">
                 <p style="line-height: 500px">APP正在紧锣密鼓的制作中敬请期待</p>
            </div>

            <!--&lt;!&ndash;右侧广告栏&ndash;&gt;-->
            <div class="right-adv-block">
                <div class="adv-img-block">
                    <img src="<%=basePath%>/JKCJ/images/adv-1.png">
                </div>
                <div class="adv-img-block">
                    <img src="<%=basePath%>/JKCJ/images/adv_3.png">
                </div>
            </div>
