            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="test">
                <li class="layui-nav-item layui-nav-itemed">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd class="layui-this"><a href="Policy">政策广告</a></dd>
   ...
   <div class="layui-body">
        ...
        <div class="advertis-content">
           ...
           <div class="advertis-block">
               <span>广告位1</span>
  <form method="post" action="ImageDate1" class="layui-form">
               <img title="点击图片选择需要更换的图片" src="upload/${a1}" class="adv-img-btn4" ><!--  -->
         <input type="hidden" id="id4" name="id" value="4"></input>
             <input type="hidden" id="a4" name="aa"></input>
            
             <input type="hidden" id="type4" name="type" value="1"></input>
               <div class="adv-btns">
            ...
            <div class="advertis-block">
                <span>广告位2</span>
                 <form method="post" action="ImageDate1" class="layui-form">
                <img title="点击图片选择需要更换的图片" src="upload/${a2}" class="adv-img-btn5" ><!--  -->
          <input type="hidden" id="id5" name="id" value="5"></input>
             <input type="hidden" id="a5" name="aa"></input>
            
             <input type="hidden" id="type5" name="type" value="1"></input>
               <div class="adv-btns">
            ...
            <div class="advertis-block">
                <span>广告位3</span>
                  <form method="post" action="ImageDate1" class="layui-form">
                 <img title="点击图片选择需要更换的图片" src="upload/${a3}" class="adv-img-btn6" ><!--  -->
         <input type="hidden" id="id6" name="id" value="6"></input>
             <input type="hidden" id="a6" name="aa"></input>
            
             <input type="hidden" id="type6" name="type" value="1"></input>
