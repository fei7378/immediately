...
public class PolicyPage extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<user.UserOfPolicy> listPolicysub = Test1.selectPolicyNum(0, 10);
		...
		request.setAttribute("policy", listPolicysub);
		...
		request.getRequestDispatcher("/JKCJ/jsp/policy.jsp").forward(request, response);
